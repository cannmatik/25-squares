...
export const LEVELS = {
    ...
    2: [
        // World 2: Easier than before, but harder than World 1
        { id: 1, ruleSet: 7, stars: [15, 18, 22], fixedStart: { x: 0, y: 0 }, blockedSquares: [], timeLimit: null, requiredMoves: [{ moveNumber: 3, x: 3, y: 0 }] },
        { id: 2, ruleSet: 7, stars: [15, 18, 22], fixedStart: { x: 2, y: 2 }, blockedSquares: [], timeLimit: null, requiredMoves: [{ moveNumber: 2, x: 4, y: 4 }] },
        { id: 3, ruleSet: 7, stars: [16, 20, 23], fixedStart: { x: 4, y: 0 }, blockedSquares: [], timeLimit: null, requiredMoves: [{ moveNumber: 3, x: 1, y: 0 }] },
